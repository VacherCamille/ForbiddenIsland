...
public class VueAventurier extends Observe {
    ...
    public void initJDialogDonnerCarte() {
        ...
        if (joueur.getDeckTresor().isEmpty()) {
            btnDonnerCarteOk.setEnabled(false);
        }
    }
    ...
    private void initJDialogBouger() {
        ...
        JLabel labelDepLigne = new JLabel("LIGNE : ");
        labelDepLigne.setHorizontalAlignment(CENTER);
        depLigne = new JComboBox();

        int posJLigne = joueur.getPosition().getLigne();
        if (posJLigne != 0) {
            depLigne.addItem(posJLigne - 1);
        }
        ...
        JLabel labelDepColonne = new JLabel("COLONNE : ");
        labelDepColonne.setHorizontalAlignment(CENTER);
        depColonne = new JComboBox();

        int posJColonne = joueur.getPosition().getColonne();
        if (posJColonne != 0) {
            depColonne.addItem(posJColonne - 1);
        }
    ...
    private void initJDialogAssecher() {
        ...
        JLabel labelAssLigne = new JLabel("LIGNE : ");
        labelAssLigne.setHorizontalAlignment(CENTER);
        assechLigne = new JComboBox();

        int posJLigne = joueur.getPosition().getLigne();
        if (posJLigne != 0) {
            assechLigne.addItem(posJLigne - 1);
        }
        ...
        JLabel labelAssColonne = new JLabel("COLONNE : ");
        labelAssColonne.setHorizontalAlignment(CENTER);
        assechColonne = new JComboBox();

        int posJColonne = joueur.getPosition().getColonne();
        if (posJColonne != 0) {
            assechColonne.addItem(posJColonne - 1);
        }
