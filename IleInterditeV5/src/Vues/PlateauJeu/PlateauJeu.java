...
public class PlateauJeu extends Observe {
    ...
    public PlateauJeu(int nbJoueur) {
        ...
        panelLeft.setOpaque(false);
            panelJ1H = new JPanel(new GridLayout(2, 1, 2, 2)); panelJ1H.setOpaque(false);
            panelJ1F = new JPanel(); panelJ1F.setOpaque(false);
            panelTresor = new JPanel(new GridLayout(1, 2, 2, 2));
                panelTresor.setOpaque(false);
                panelTresor.setBorder(new EmptyBorder(5, 5, 5, 5));
            panelJ3H = new JPanel(new GridLayout(2, 1, 2, 2)); panelJ3H.setOpaque(false);
            panelJ3F = new JPanel(); panelJ3F.setOpaque(false);
        ...
        panelRight.setOpaque(false);
            panelJ2H = new JPanel(new GridLayout(2, 1, 2, 2)); panelJ2H.setOpaque(false);
            panelJ2F = new JPanel(); panelJ2F.setOpaque(false);
            ...
            panelJ4H = new JPanel(new GridLayout(2, 1, 2, 2)); panelJ4H.setOpaque(false);
            panelJ4F = new JPanel(); panelJ4F.setOpaque(false);
    ...
    public void updateCurrentPlayer(Aventurier aventurier, int waterLevel) {
        ...
        // deck carte tresor :
        panelGauche = new JPanel(); panelGauche.setOpaque(false);
            panelCarte = new JPanel(new GridLayout(1, nbDeck, 20, 20)); panelCarte.setOpaque(false);
    ...
    public void updateJ1(Aventurier joueur1) {
        ...
        switch (joueur1.getRole().getPion()) {
            case VIOLET: couleur = JPanelBackground.VIOLET; break;
            case BLEU: couleur = JPanelBackground.BLEU; break;
            case JAUNE: couleur = JPanelBackground.JAUNE; break;
            case ORANGE: couleur = JPanelBackground.ORANGE; break;
            case ROUGE: couleur = JPanelBackground.ROUGE; break;
            case VERT: couleur = JPanelBackground.VERT; break;
            default: couleur = JPanelBackground.CURRENT_PLAYER; break;
        }
    ...
    public void desactiverTuile(TuileGraphique tuile, String action) {
        if (action.equals("déplacer")) tuile.removeMouseListener(mlDeplacer);
        if (action.equals("assécher")) tuile.removeMouseListener(mlAssecher);
    }
