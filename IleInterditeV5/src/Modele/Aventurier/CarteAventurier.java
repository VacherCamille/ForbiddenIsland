...
public abstract class CarteAventurier {
    ...
    public ArrayList<Tuile> getTuilesAdjacentes(int posL, int posC) {//navigateur
        Aventurier joueur = getJoueur();
